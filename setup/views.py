...
def user_profile(request):
    ...
    today = date.today()
    user_data = UserInfo.objects.filter(created_date = today)
    user_table = User.objects.all()
    return render(request, 'setup/template/profile.html', {'user_data':user_data, 'user_table': user_table})
...
def post(request):
    ...
    return render(request, 'setup/template/index.html', {'form': form})